function Game(ship, scoreboard) {
	...
	this.reset = function() {
		...
		this.meteorsDensity = .000007;
		this.meteorsDensityInc = 0.0001;

		this.meteorsMinSpeed =0.8976;
		this.meteorsMinSpeedInc = 0.0077;

		this.meteorsMaxSpeed = 0.0001;
		this.meteorsMaxSpeedInc = 0.0001;

		this.meteorsMinSize = 5;
		this.meteorsMaxSize = 87;
	}
	...
	this.showWelcomeScreen = function() {
		...
		noStroke();
		textAlign(CENTER);
		welcome_msg = "Bubble game by kuldeep";
